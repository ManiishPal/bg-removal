...
const Header = () => {
  ...
  return (
    <div className='flex items-center justify-between max-sm:flex-row-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:pt-20'>
        {/* left side */}
        <div>
            ...
            Lorem Ipsum has been the industry's standard dummy text ever.</p>
                <div>
                    <input onChange={(e) => removeBg(e.target.files[0])} type="file" accept='*' id='upload1' hidden />
